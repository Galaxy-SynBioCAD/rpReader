...
class rpReader:
    ...
    def setCache(self, 
        ...
        self.deprecatedMNXR_mnxr = deprecatedMNXR_mnxr
        self.mnxm_strc = mnxm_strc
        self.inchikey_mnxm = inchikey_mnxm
        self.rr_reactions = rr_reactions
        self.chemXref = chemXref
        self.compXref = compXref
        self.nameCompXref = nameCompXref
